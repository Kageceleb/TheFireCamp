...
/**
 * Tip: creates a campaign and makes the creator its DM in one atomic
 * database call (see supabase/migrations/0003_create_campaign_function.sql
 * for why this has to be a single RPC rather than two separate inserts).
 */
